...
def main(config):
    ...
    shutil.copy(f'main_vitmoge.py', os.path.join(config.OUTPUT, 'main_vitmoge.py'))
    ...
    shutil.copy(f'./models/vision_transformer_moge.py', os.path.join(config.OUTPUT, 'vision_transformer_moge.py'))
    ...
    sigma_scheduler = SigmaScheduler(config.MODEL.VIT_MOGE.GS_SIGMA_FINAL, config.MODEL.VIT_MOGE.GS_SIGMA_INIT,
                                     len(data_loader_train) * config.TRAIN.EPOCHS,
                                     gamma=config.MODEL.VIT_MOGE.GS_SIGMA_POWER)
