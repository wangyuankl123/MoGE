...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 is_group_sparsity_loss=False, gs_loss_weight=None, gs_map_size=None, gs_window_size=None, gs_stride=None):
...
class SwinTransformerMoGE(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        assert is_group_sparsity_loss, "The parameter is_group_sparsity of SwinTransformerMoGE should be True "
    ...
    def forward_features(self, x, sigma=0):
