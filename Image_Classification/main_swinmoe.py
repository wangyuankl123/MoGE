...
def main(config):
    ...
    shutil.copy(f'main_swinmoe.py', os.path.join(config.OUTPUT, 'main_swinmoe.py'))
    ...
    shutil.copy(f'./models/swin_transformer_moe.py', os.path.join(config.OUTPUT, 'swin_transformer_moe.py'))
    shutil.copy(f'./models/vision_transformer_moe.py', os.path.join(config.OUTPUT, 'vision_transformer_moe.py'))
